                ...
                <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
                    ...
                    <div style="padding-bottom: 40px; text-align:center;">
                        <a href="${resetLink}" rel="noopener"
                           ...
                           target="_blank">${buttonTitle}</a>
                    </div>
                    <div style="padding-bottom: 30px">${message2}</div>
                    <div style="border-bottom: 1px solid #eeeeee; margin: 15px 0"></div>
                    <div style="padding-bottom: 50px; word-wrap: break-all;">
                        <p style="margin-bottom: 10px;">${message3}</p>
                        <a href="${resetLink}" rel="noopener"
                           target="_blank" style="text-decoration:none;color: #009ef7">${resetLink}</a>
                    </div>
                    <!--end:Email content-->
                    <div style="padding-bottom: 10px">${bestRegards}
                        ...
                        <tr>
                            <td align="center" valign="center"
                                ...
                                <p>Copyright &copy;
                                    <a href="https://mat-data.com" rel="noopener" target="_blank">mat-data</a>.</p>
                            </td>
                        </tr>
                        <br/></div>
                </div>
